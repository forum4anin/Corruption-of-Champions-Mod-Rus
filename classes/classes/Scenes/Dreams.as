			...
			if (dreamtemp > 5) {
				...
				//minotaur cum
					...
					if (player.hasVagina() && (!player.hasCock() || rand(2) == 0)) {
						...
						if (player.cor > 80) {
						outputText("/n/nYou had the feeling that this feline would have you for many more hours to come...");
